...
class CountryDetailsViewController: UIViewController {
    ...
    var countryData = CountryViewModel(dataServiceCall: ServiceCalls())
    
    var serviceCall: ServiceCalls? {
        didSet{
            guard let _ = serviceCall else { return }
            initializeClosures()
        }
    }
...
extension CountryDetailsViewController{
    ...
    func setupContentView(){
        ...
        countrytableView.register(CountryDetailTableViewCell.self, forCellReuseIdentifier: COUNTRY_DETAIL_CELL_NAME)
...
extension CountryDetailsViewController{
    ...
    func showDataLoadingErrorAlert(){
        let networkAlert = UIAlertController(title: API_CALL_ERROR_ALERT, message: self.countryData.error?.localizedDescription, preferredStyle: .alert)
